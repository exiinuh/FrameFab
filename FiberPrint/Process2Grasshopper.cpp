...
Process2Grasshopper::Process2Grasshopper( )
{
...
Process2Grasshopper::Process2Grasshopper(SeqAnalyzer *seqanalyzer, char *path)
{
...
void Process2Grasshopper::ReadLayerQueue()
{
	string path = path_;
...
bool  Process2Grasshopper::IfPointInVector(point p)
{
...
void Process2Grasshopper::Write()
{
	string path = path_;
